var isNode = new Function('return (typeof process !== "undefined") && (process.release.name === "node")');
(function (root, factory) {
    ...
    var resemble = function (fileData) {
        ...
        function isContrasting(d1, d2) {
            return (Math.abs(d1.brightness - d2.brightness) >
    ...
    function setGlobalOutputSettings(settings) {
        var msg = 'resemble.outputSettings mutates global state, and will be removed in a later major version';
        console.warn(msg);
